...
-- Forward-declare all panels so SwitchTab can reference them as upvalues
local spawnPanel, toolsPanel, wearsPanel, coloursPanel, tricksPanel
...
coloursPanel  = Instance.new("Frame")
...
tricksPanel  = Instance.new("Frame")
